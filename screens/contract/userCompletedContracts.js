...
function UserCompletedContracts({ route, navigation }) {
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: Colors.whiteColor }}>
      ...
      <SwipeListView
        data={
          contractData
            ? contractData
                .filter((x) => x.TenantSignature && x.LandlordSignature)
                .filter(
                  (item) =>
...
UserCompletedContracts.navigationOptions = () => {
  return {
    header: () => null,
...
export default UserCompletedContracts;
